async function render_home() {
    ...
    you are not supposed to. Use the menu on the left hand side to pick a report to display. If you have questions, please reach out to users@infra.apache.org";
